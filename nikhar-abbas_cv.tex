...
{Research in optimiziation and control of a grid connected solar-plus-battery system in Kathmandu, Nepal to improve voltage quality for local feeder connections. The work was primarily conducted through MATLAB and OpenDSS and in collaboration with the NGO, RIDS-Nepal.}
...
\printbibliography[keyword={first-author-journal}, title={First-Author Journal Papers}]
\printbibliography[keyword={first-author-conference}, title={First-Author Conference Papers}]
\printbibliography[keyword={presentation}, title={Presentations}]
\printbibliography[keyword={refereed-journal}, title={Refereed Journal Papers}]
\printbibliography[keyword={refereed-report}, title={Refereed Technical Reports}]
\printbibliography[keyword={refereed-conference}, title={Refereed Conference Papers}]
...
{Winter Park, Colorado}{}{Volunteer instructor with the NSCD assisted program ski program, a program that brings disabled persons onto the ski slopes of the Winter Park Ski Resort in Colorado.
}
\cventry{\datepres[07.2021]}{Surplus Food Distribution}{Denver Food Rescue}
{Denver, CO}{}
{Transport surplus food around Denver, primarily by bicycle. DFR works to collect unwanted food and distributes to community centers that then provide the food to those in need.
}


\section{Hobbies and Interests}
\cvitem{}{A list of activities that fill my proverbial cup:}{}{}
{
\cvlistitem{A general love for spending time in the outdoors -- activities including but not limited to: trail running, rock climbing, bicycle riding, and skiing.}
\cvlistitem{General handy-work regarding my home, vehicle, and bicycle.}
\cvlistitem{Ultimate frisbee and soccer}
}
