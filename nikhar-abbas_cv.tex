...
\begin{itemize}
    \item Creator and lead developer of the Reference OpenSource Controller (ROSCO) -- a fully automated wind turbine controller tuning and implementation framework for use by the wind energy community (800+ documentation visits from 25 countries.)
    ...
    \item Co-design optimization of trailing-edge flaps on low specific power rotors to reduce the cost of energy.
    \item Analysis of controller influence on optimized wind turbine design through robust stability margin constrained controller tuning processes.
\end{itemize}
}
...
\cvlistitem{General handy-work regarding mantainance and improvements to my home, vehicle, and bicycle.}
